...
public class ChooseAppleLambda {
    ...
    public static void main(String[] args) {
        ...
        // 过滤列表中的绿苹果并打印（使用Lambda）
        printInfoInList(filterApples(appleList, (Apple a) -> Apple.GREEN.equals(a.getColor())));

        System.out.println("-----质量大于150g的苹果列表-----");
        //过滤出列表中质量大于150g的水果并打印（使用Lambda）
        printInfoInList(filterApples(appleList, (Apple a) -> a.getWeight() > 150));

        System.out.println("-----质量小于80g或者为棕色的苹果列表-----");
        //过滤出列表中质量小于80g或者为棕色的水果并打印（使用Lambda）
        printInfoInList(filterApples(appleList, (Apple a) -> a.getWeight() < 80 || Apple.GROWN.equals(a.getColor())));
